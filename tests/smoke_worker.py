...
READ_PAGES = [
    ...
    "/hdc/accounts/hub", "/hdc/accounts/manage", "/hdc/accounts/new",
    "/hdc/accounts/entries", "/hdc/accounts/reconciliation",
    "/hdc/accounts/money-center", "/hdc/accounts/new-transaction",
    "/hdc/accounts/cashflow", "/hdc/accounts/cashflow/register",
